...
async def run_story_precheck(client: TelegramClient, account_id: int) -> Dict[str, Any]:
    ...
    Returns:
      {
        "status": "allowed" | "rate_limited" | "frozen" | "restricted" | "blocked" | "failed_check" | "unknown",
        "reason": str,
