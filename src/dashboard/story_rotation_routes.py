...
AutoStory (the recurring-campaign product) was retired 2026-09-03 -- see
docs/AUTOSTORY_RETIRED_20260903.md. The /auto-campaigns/* routes that used
to live in this file are gone; every route remaining here (precheck,
dry-run, runtime-map, runs, readiness-preview, eligible-accounts) is the
shared "Manual Story run" capability (controlled_live_run.py and friends),
proven independently used by src/dashboard/routes.py and other callers,
and preserved as-is.
"""
